...
# ==========================================
# Add your preferred LLM provider's API key below.
# For a full list of required keys per provider, see:
# https://mastra.ai/models/environment-variables
`;
    ...
    fs.writeFile(import.meta.dirname + '/.env', contents, (err) => {
        if (err) {
            ...
            console.log('⚠️  Next Step: Connect your Mastra AI model by adding your provider key to the .env file.');
            console.log('   See https://mastra.ai/models/environment-variables for the correct variable names.');
